...
type TranslationKeys = {
  ...
  docs_mock_trial: string;
  docs_mock_trial_content: string;
...
const pt: TranslationKeys = {
  ...
  docs_student_portal_content: "Os alunos e professores têm um portal dedicado para realizar e acompanhar avaliações online.\n\n• Acesso: entram com e-mail cadastrado e código (PIN) da avaliação.\n• Detecção automática: o sistema identifica se o PIN é de uma prova online, paciente virtual ou simulação e redireciona automaticamente.\n• Modo Individual: cada aluno acessa e realiza a avaliação individualmente.\n• Modo em Grupo: múltiplos alunos podem entrar simultaneamente com seus e-mails. O sistema valida todos os e-mails e cria sessões sincronizadas — mensagens, notas e analytics são compartilhados igualmente para todo o grupo.\n• Realização: respondem dentro do tempo limite configurado.\n• Envio: ao finalizar, as respostas são enviadas automaticamente.\n• Resultados: após correção, podem consultar notas e feedback.",
  ...
  docs_virtual_patients: "Pacientes Virtuais",
  docs_virtual_patients_content: "O módulo de Pacientes Virtuais permite criar consultas simuladas com IA para treinamento clínico.\n\n• Crie pacientes virtuais com perfil completo (queixa, história clínica, exames, conduta esperada).\n• Os alunos conversam com o paciente virtual via chat alimentado por IA.\n• O sistema avalia automaticamente a conduta do aluno usando o MAI (Medication Appropriateness Index).\n• Vinculação a turmas: associe pacientes virtuais a turmas com código de acesso (PIN) automático.\n• Modo de Avaliação Exclusivo: cada turma pode ter Prova Online OU Paciente Virtual vinculado.\n• Avaliação Individual ou em Grupo: no portal do aluno, escolha entre modo individual ou grupo.\n• Modo Grupo: múltiplos alunos entram simultaneamente com seus e-mails validados. Mensagens, notas e analytics são sincronizados para todos os membros do grupo.\n• Avaliação entre Pares: ao enviar o MAI, cada integrante do grupo recebe um e-mail para avaliar os colegas (participação, contribuição técnica e colaboração). O resultado vira um bônus/penalidade individual de até ±1,0 ponto, diferenciando a nota de cada aluno dentro do mesmo grupo.\n• Analytics detalhado: acompanhe desempenho por aluno, sessão e turma com subscores e feedback por IA.\n• Grading automático via Edge Function com nota final, feedback resumido e orientações de melhoria.",
  docs_mock_trial: "Júri Simulado",
  docs_mock_trial_content: "O módulo de Júri Simulado organiza julgamentos simulados de casos clínicos, com grupos assumindo os papéis de Acusação, Defesa e Júri Técnico.\n\n• Crie processos a partir de casos clínicos, com personagens, testemunhas e formulários específicos por papel.\n• Vincule grupos de alunos a cada processo — o mesmo grupo pode assumir papéis diferentes em processos diferentes.\n• Um aluno assume o papel de Juiz e conduz o julgamento ao vivo (anúncio, fala da defesa, fala da acusação, perguntas do júri, deliberação, veredito), com temporizador por fase.\n• Correção automática por IA (Acusação, Defesa e Júri Técnico), complementada por avaliação do juiz e do professor.\n• Avaliação entre Pares: ao encerrar cada processo, cada integrante do grupo recebe um e-mail identificado por caso e papel para avaliar os colegas (preparação, atuação no julgamento e colaboração). O resultado vira um bônus/penalidade individual de até ±1,0 ponto, diferenciando a nota de cada aluno dentro do mesmo grupo — inclusive quando o grupo muda de papel entre processos.\n• Painel de notas por aluno com controle de presença e possibilidade de ajuste manual pelo professor.",
  docs_simulation: "Simulação Realística (Anamnese)",
  docs_simulation_content: "O módulo de Simulação Realística permite criar salas de anamnese com pares de alunos.\n\n• Crie salas com código de acesso, duração configurável e formulários personalizados.\n• Organização em pares: alunos são distribuídos em duplas com papéis alternados (entrevistador/paciente).\n• Rodadas e ciclos: o professor controla a progressão das rodadas com alternância automática de papéis.\n• Materiais pedagógicos: distribua casos clínicos e materiais por rodada.\n• Formulários de avaliação: configure formulários JSONB com campos personalizáveis.\n• Monitoramento em tempo real: acompanhe o status de cada participante e dupla.\n• Vinculação com SOAP: as salas de simulação podem ser conectadas a salas SOAP para continuidade do fluxo clínico.",
  docs_soap: "Notas SOAP",
  docs_soap_content: "O módulo SOAP permite que alunos elaborem notas clínicas estruturadas após a anamnese.\n\n• Vinculação à Simulação: crie salas SOAP conectadas a salas de anamnese, importando automaticamente participantes e pares.\n• Estrutura SOAP: formulários pré-configurados com campos Subjetivo, Objetivo, Avaliação e Plano.\n• Formulários personalizáveis: configure campos adicionais conforme a necessidade.\n• Avaliação por dupla: cada dupla elabora sua nota SOAP de forma independente.\n• Feedback do professor: o professor pode avaliar e dar feedback sobre cada nota.\n• Continuidade: as salas SOAP podem ser conectadas a salas de Reconciliação para a etapa seguinte.",
  docs_reconciliation: "Reconciliação Medicamentosa",
  docs_reconciliation_content: "O módulo de Reconciliação permite que alunos pratiquem a reconciliação medicamentosa após a elaboração da nota SOAP.\n\n• Vinculação ao SOAP: crie salas de reconciliação conectadas a salas SOAP, importando participantes automaticamente.\n• Casos clínicos: adicione casos clínicos com medicações para reconciliação.\n• Formulários específicos: configure formulários com campos para análise de medicamentos, interações e plano terapêutico.\n• Avaliação em dupla: cada dupla analisa os medicamentos e propõe ajustes.\n• Correção por IA: a IA analisa as respostas e atribui feedback automático.\n• Feedback do professor: revisão e ajuste de notas pelo professor.\n• Continuidade: conecta-se a salas de Documentação para a etapa final do fluxo.",
  docs_documentation_rooms: "Salas de Documentação",
  docs_documentation_rooms_content: "O módulo de Documentação permite que alunos pratiquem a documentação clínica completa como etapa final do fluxo pedagógico.\n\n• Vinculação à Reconciliação: crie salas de documentação conectadas a salas de reconciliação, importando participantes e casos.\n• Formulários de documentação: configure formulários com campos para prescrição, evolução e alta.\n• Avaliação em dupla: cada dupla documenta o caso de forma independente.\n• Correção por IA: feedback automático da IA sobre a qualidade da documentação.\n• Feedback do professor: revisão e avaliação manual.\n• Fluxo completo: Simulação → SOAP → Reconciliação → Documentação, formando um ciclo pedagógico integrado.",
...
const en: TranslationKeys = {
  ...
  landing_testimonials_heading: "Why choose ProvaFácil?",
  landing_cta_heading: "Ready to transform how you create exams?",
  landing_cta_sub: "Start for free and discover how the platform can optimize your work.",
  landing_cta_button: "Create my free account",
  landing_footer: "© 2026 ProvaFácil. All rights reserved.",
  landing_stats_questions: "Integrated modules",
  landing_stats_teachers: "Assessment types",
  landing_stats_time: "Available languages",
  landing_stats_rating: "Online & free to start",
  ...
  docs_student_portal_content: "Students and teachers have a dedicated portal to take and monitor online assessments.\n\n• Access: enter with registered email and assessment code (PIN).\n• Automatic detection: the system identifies if the PIN is for an online exam, virtual patient, or simulation and redirects automatically.\n• Individual Mode: each student accesses and takes the assessment individually.\n• Group Mode: multiple students can enter simultaneously with their emails. The system validates all emails and creates synchronized sessions — messages, grades, and analytics are shared equally for the entire group.\n• Taking: answer within the configured time limit.\n• Submission: upon completion, answers are submitted automatically.\n• Results: after grading, students can check their grades and feedback.",
  ...
  docs_virtual_patients: "Virtual Patients",
  docs_virtual_patients_content: "The Virtual Patients module allows creating AI-powered simulated consultations for clinical training.\n\n• Create virtual patients with full profiles (chief complaint, clinical history, exams, expected conduct).\n• Students chat with the AI-powered virtual patient via chat.\n• The system automatically evaluates student conduct using the MAI (Medication Appropriateness Index).\n• Class linking: associate virtual patients with classes using automatic access codes (PIN).\n• Exclusive Assessment Mode: each class can have an Online Exam OR a Virtual Patient linked, never both.\n• Individual or Group evaluation: in the student portal, choose between individual or group mode.\n• Group Mode: multiple students enter simultaneously with validated emails. Messages, grades, and analytics are synchronized for all group members.\n• Peer Evaluation: once the group submits the MAI, each member gets an e-mail to rate their teammates (participation, technical contribution, collaboration). The result becomes an individual bonus/penalty of up to ±1.0 point, so grades can differ between students in the same group.\n• Detailed analytics: track performance by student, session, and class with subscores and AI feedback.\n• Automatic grading via Edge Function with final score, summarized feedback, and improvement guidance.",
  docs_mock_trial: "Mock Trial",
  docs_mock_trial_content: "The Mock Trial module organizes simulated trials of clinical cases, with groups taking on the roles of Prosecution, Defense, and Technical Jury.\n\n• Create cases from clinical scenarios, with characters, witnesses, and role-specific forms.\n• Link student groups to each case — the same group can play different roles in different cases.\n• One student takes the Judge role and runs the live trial (announcement, defense, prosecution, jury questions, deliberation, verdict), with a per-phase timer.\n• Automatic AI grading (Prosecution, Defense, and Technical Jury), complemented by judge and teacher evaluation.\n• Peer Evaluation: when each case is finished, every group member gets an e-mail labeled with the case and role to rate their teammates (preparation, performance during the trial, and collaboration). The result becomes an individual bonus/penalty of up to ±1.0 point, so grades can differ between students in the same group — even when the group's role changes between cases.\n• Per-student score panel with attendance tracking and manual override by the teacher.",
  docs_simulation: "Realistic Simulation (History Taking)",
  docs_simulation_content: "The Realistic Simulation module allows creating history-taking rooms with student pairs.\n\n• Create rooms with access code, configurable duration, and custom forms.\n• Pair organization: students are distributed in pairs with alternating roles (interviewer/patient).\n• Rounds and cycles: the teacher controls round progression with automatic role alternation.\n• Pedagogical materials: distribute clinical cases and materials per round.\n• Evaluation forms: configure JSONB forms with customizable fields.\n• Real-time monitoring: track the status of each participant and pair.\n• SOAP linking: simulation rooms can be connected to SOAP rooms for clinical flow continuity.",
  docs_soap: "SOAP Notes",
  docs_soap_content: "The SOAP module allows students to write structured clinical notes after history taking.\n\n• Simulation linking: create SOAP rooms connected to history-taking rooms, automatically importing participants and pairs.\n• SOAP structure: pre-configured forms with Subjective, Objective, Assessment, and Plan fields.\n• Customizable forms: configure additional fields as needed.\n• Pair evaluation: each pair writes their SOAP note independently.\n• Teacher feedback: the teacher can evaluate and provide feedback on each note.\n• Continuity: SOAP rooms can be connected to Reconciliation rooms for the next step.",
  docs_reconciliation: "Medication Reconciliation",
  docs_reconciliation_content: "The Reconciliation module allows students to practice medication reconciliation after SOAP note writing.\n\n• SOAP linking: create reconciliation rooms connected to SOAP rooms, automatically importing participants.\n• Clinical cases: add clinical cases with medications for reconciliation.\n• Specific forms: configure forms with fields for drug analysis, interactions, and therapeutic plan.\n• Pair evaluation: each pair analyzes medications and proposes adjustments.\n• AI grading: AI analyzes responses and provides automatic feedback.\n• Teacher feedback: review and adjust grades.\n• Continuity: connects to Documentation rooms for the final step of the flow.",
  docs_documentation_rooms: "Documentation Rooms",
  docs_documentation_rooms_content: "The Documentation module allows students to practice complete clinical documentation as the final step of the pedagogical flow.\n\n• Reconciliation linking: create documentation rooms connected to reconciliation rooms, importing participants and cases.\n• Documentation forms: configure forms with fields for prescriptions, progress notes, and discharge.\n• Pair evaluation: each pair documents the case independently.\n• AI grading: automatic AI feedback on documentation quality.\n• Teacher feedback: manual review and evaluation.\n• Complete flow: Simulation → SOAP → Reconciliation → Documentation, forming an integrated pedagogical cycle.",
...
const es: TranslationKeys = {
  ...
  landing_testimonials_heading: "¿Por qué elegir ProvaFácil?",
  landing_cta_heading: "¿Listo para transformar su forma de crear exámenes?",
  landing_cta_sub: "Comience gratis y descubra cómo la plataforma puede optimizar su trabajo.",
  landing_cta_button: "Crear mi cuenta gratis",
  landing_footer: "© 2026 ProvaFácil. Todos los derechos reservados.",
  landing_stats_questions: "Módulos integrados",
  landing_stats_teachers: "Tipos de evaluación",
  landing_stats_time: "Idiomas disponibles",
  landing_stats_rating: "Online y gratuito",
  ...
  docs_classes_content: "Organice sus alumnos en clases para facilitar la aplicación de evaluaciones.\n\n• Cree clases con nombre, semestre y descripción.\n• Gestione la lista de alumnos de cada clase (nombre, email, matrícula).\n• Modo de Evaluación Exclusivo: cada clase puede vincularse a un Examen en Línea O a un Paciente Virtual, nunca ambos al mismo tiempo.\n• Vincule exámenes en línea a las clases para aplicación dirigida.\n• Vincule pacientes virtuales a las clases con código de acceso (PIN) automático.\n• Duplique clases para reutilizar la estructura en nuevos semestres.",
  ...
  docs_student_portal_content: "Los alumnos y profesores tienen un portal dedicado para realizar y acompañar evaluaciones en línea.\n\n• Acceso: ingresan con email registrado y código (PIN) de la evaluación.\n• Detección automática: el sistema identifica si el PIN es de un examen en línea, paciente virtual o simulación y redirige automáticamente.\n• Modo Individual: cada alumno accede y realiza la evaluación individualmente.\n• Modo en Grupo: múltiples alumnos pueden ingresar simultáneamente con sus emails. El sistema valida todos los emails y crea sesiones sincronizadas — mensajes, notas y analytics se comparten igualmente para todo el grupo.\n• Realización: responden dentro del tiempo límite configurado.\n• Envío: al finalizar, las respuestas se envían automáticamente.\n• Resultados: después de la corrección, pueden consultar notas y retroalimentación.",
  ...
  docs_virtual_patients: "Pacientes Virtuales",
  docs_virtual_patients_content: "El módulo de Pacientes Virtuales permite crear consultas simuladas con IA para entrenamiento clínico.\n\n• Cree pacientes virtuales con perfil completo (queja principal, historia clínica, exámenes, conducta esperada).\n• Los alumnos conversan con el paciente virtual vía chat alimentado por IA.\n• El sistema evalúa automáticamente la conducta del alumno usando el MAI (Medication Appropriateness Index).\n• Vinculación a clases: asocie pacientes virtuales a clases con código de acceso (PIN) automático.\n• Modo de Evaluación Exclusivo: cada clase puede tener un Examen en Línea O un Paciente Virtual vinculado, nunca ambos.\n• Evaluación Individual o en Grupo: en el portal del alumno, elija entre modo individual o grupo.\n• Modo Grupo: múltiples alumnos ingresan simultáneamente con sus emails validados. Mensajes, notas y analytics se sincronizan para todos los miembros del grupo.\n• Evaluación entre Pares: al enviar el MAI, cada integrante del grupo recibe un correo para evaluar a sus compañeros (participación, contribución técnica y colaboración). El resultado se convierte en un bono/penalización individual de hasta ±1,0 punto, diferenciando la nota de cada alumno dentro del mismo grupo.\n• Analytics detallado: acompañe el desempeño por alumno, sesión y clase con subscores y feedback por IA.\n• Calificación automática vía Edge Function con nota final, feedback resumido y orientaciones de mejora.",
  docs_mock_trial: "Juicio Simulado",
  docs_mock_trial_content: "El módulo de Juicio Simulado organiza juicios simulados de casos clínicos, con grupos asumiendo los roles de Acusación, Defensa y Jurado Técnico.\n\n• Cree procesos a partir de casos clínicos, con personajes, testigos y formularios específicos por rol.\n• Vincule grupos de alumnos a cada proceso — el mismo grupo puede asumir roles diferentes en procesos diferentes.\n• Un alumno asume el rol de Juez y conduce el juicio en vivo (anuncio, alegato de la defensa, alegato de la acusación, preguntas del jurado, deliberación, veredicto), con temporizador por fase.\n• Calificación automática por IA (Acusación, Defensa y Jurado Técnico), complementada por evaluación del juez y del profesor.\n• Evaluación entre Pares: al cerrar cada proceso, cada integrante del grupo recibe un correo identificado por caso y rol para evaluar a sus compañeros (preparación, actuación en el juicio y colaboración). El resultado se convierte en un bono/penalización individual de hasta ±1,0 punto, diferenciando la nota de cada alumno dentro del mismo grupo — incluso cuando el grupo cambia de rol entre procesos.\n• Panel de notas por alumno con control de asistencia y ajuste manual por el profesor.",
  docs_simulation: "Simulación Realista (Anamnesis)",
  docs_simulation_content: "El módulo de Simulación Realista permite crear salas de anamnesis con pares de alumnos.\n\n• Cree salas con código de acceso, duración configurable y formularios personalizados.\n• Organización en pares: los alumnos se distribuyen en duplas con roles alternados (entrevistador/paciente).\n• Rondas y ciclos: el profesor controla la progresión de las rondas con alternancia automática de roles.\n• Materiales pedagógicos: distribuya casos clínicos y materiales por ronda.\n• Formularios de evaluación: configure formularios JSONB con campos personalizables.\n• Monitoreo en tiempo real: acompañe el estado de cada participante y dupla.\n• Vinculación con SOAP: las salas de simulación pueden conectarse a salas SOAP para continuidad del flujo clínico.",
  docs_soap: "Notas SOAP",
  docs_soap_content: "El módulo SOAP permite que los alumnos elaboren notas clínicas estructuradas después de la anamnesis.\n\n• Vinculación a la Simulación: cree salas SOAP conectadas a salas de anamnesis, importando automáticamente participantes y pares.\n• Estructura SOAP: formularios preconfigurados con campos Subjetivo, Objetivo, Evaluación y Plan.\n• Formularios personalizables: configure campos adicionales según la necesidad.\n• Evaluación por dupla: cada dupla elabora su nota SOAP de forma independiente.\n• Feedback del profesor: el profesor puede evaluar y dar retroalimentación sobre cada nota.\n• Continuidad: las salas SOAP pueden conectarse a salas de Reconciliación para la siguiente etapa.",
  docs_reconciliation: "Reconciliación Medicamentosa",
  docs_reconciliation_content: "El módulo de Reconciliación permite que los alumnos practiquen la reconciliación medicamentosa después de la elaboración de la nota SOAP.\n\n• Vinculación al SOAP: cree salas de reconciliación conectadas a salas SOAP, importando participantes automáticamente.\n• Casos clínicos: agregue casos clínicos con medicamentos para reconciliación.\n• Formularios específicos: configure formularios con campos para análisis de medicamentos, interacciones y plan terapéutico.\n• Evaluación en dupla: cada dupla analiza los medicamentos y propone ajustes.\n• Corrección por IA: la IA analiza las respuestas y atribuye feedback automático.\n• Feedback del profesor: revisión y ajuste de notas por el profesor.\n• Continuidad: se conecta a salas de Documentación para la etapa final del flujo.",
  docs_documentation_rooms: "Salas de Documentación",
  docs_documentation_rooms_content: "El módulo de Documentación permite que los alumnos practiquen la documentación clínica completa como etapa final del flujo pedagógico.\n\n• Vinculación a la Reconciliación: cree salas de documentación conectadas a salas de reconciliación, importando participantes y casos.\n• Formularios de documentación: configure formularios con campos para prescripción, evolución y alta.\n• Evaluación en dupla: cada dupla documenta el caso de forma independiente.\n• Corrección por IA: feedback automático de la IA sobre la calidad de la documentación.\n• Feedback del profesor: revisión y evaluación manual.\n• Flujo completo: Simulación → SOAP → Reconciliación → Documentación, formando un ciclo pedagógico integrado.",
