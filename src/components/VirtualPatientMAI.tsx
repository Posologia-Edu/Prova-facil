...
const MAI_CRITERIA = [
  ...
  { key: "correct_directions", label: "Técnica de administração", description: "A técnica de administração está correta?" },
  { key: "practical_directions", label: "Comodidade terapêutica", description: "Há comodidade terapêutica?" },
